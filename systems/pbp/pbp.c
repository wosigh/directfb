...
system_get_info( CoreSystemInfo *info )
{
     ...
     snprintf( info->name, DFB_CORE_SYSTEM_INFO_NAME_LENGTH, "PBP" );
}
...
system_initialize( CoreDFB *core, void **data )
{
     ...
     fusion_arena_add_shared_field( dfb_core_arena( core ), "PBP", dfb_pb );
...
system_join( CoreDFB *core, void **data )
{
     ...
     fusion_arena_get_shared_field( dfb_core_arena( core ), "PBP", &ret );
