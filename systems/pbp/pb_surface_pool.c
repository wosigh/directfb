                      ...
                      void                  *alloc_data )
{
	 ...
	 if (surface->type & CSTF_LAYER) {
		  ...
		  DFBResult ret = pb_primarymemmanager_allocate(dfb_pb->primary_mem_mgr, &alloc->addr);
		  D_ASSERT(ret == DFB_OK);
                        ...
                        void                  *alloc_data )
{
	 ...
	 if (surface->type & CSTF_LAYER) {
		  ...
		  DFBResult ret = pb_primarymemmanager_deallocate(dfb_pb->primary_mem_mgr, alloc->addr);
	 } else {
	 	  D_FREE( alloc->addr );
